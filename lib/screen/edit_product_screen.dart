...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void _updateImageUrl() {
    ...
    // || (!_imageUrlController.toString().endsWith('.png') && !_imageUrlController.toString().endsWith('.jpg') && !_imageUrlController.toString().endsWith('.jpeg'))
    {
      return;
    }
    setState(() {});
                        ...
                        Expanded(
                          child: TextFormField(
                            ...
                            validator: (value) {
                              ...
                              //    return 'Please enter valid image format';
                              //  }
                              return null;
                            },
                            onSaved: (value) {
